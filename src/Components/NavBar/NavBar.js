      ...
      <Navbar className='Navbar'
        ...
        <Navbar.Collapse>
          <Nav className='me-auto my-2 my-lg-0'>
            ...
            <Nav.Link href="Series"><Link to='/Series'>Series</Link></Nav.Link>
            <Nav.Link href="Movies"><Link to='/Movies'>Movies</Link></Nav.Link>
            <Nav.Link href="Latest"><Link to='/Latest'>Latest</Link></Nav.Link>
            <Nav.Link href="Mylist"><Link to='/Mylist'>My list</Link></Nav.Link>
          </Nav>
